 ...
 *
 * Lives on `/` — it is what a visitor should meet first — with the studio
 * workbench moved to /studio. Fully self-contained: all keyframes/utilities live
...
const STUDIO_HREF = "/studio"; // the workbench moved off the root when this page took it
